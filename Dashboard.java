...
//        ImageIcon i1 = new ImageIcon("icons/deshboard.jpg");
//        ImageIcon i1 = new ImageIcon("icons/dash.jpg");
        ImageIcon i1 = new ImageIcon("icons/board.jpg");
//        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/third.jpg"));
	...
	NewLabel.setBounds(0, 0, 1950, 1000); 
        ...
        JLabel AirlineManagementSystem = new JLabel("Five Star GROUP WELCOMES YOU");
	AirlineManagementSystem.setForeground(Color.RED);
	AirlineManagementSystem.setBackground(Color.gray);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 46));
	AirlineManagementSystem.setBounds(300, 20, 1000, 85);
